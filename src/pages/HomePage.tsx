...
function HomePage() {
  ...
  const handleAddDataset = (datasetInfo: any) => {
    ...
    // Aquí iría la lógica para guardar el dataset en el backend
  };
  ...
  return (
    <div className="min-h-screen bg-cyber-dark flex flex-col">
      ...
      {/* Contenido principal */}
      <div className="p-4 space-y-6 bg-transparent flex-1">
        ...
        {/* FILA INFERIOR: Gráficos (solo se muestra DatasetsChart) */}
