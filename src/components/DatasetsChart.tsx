...
import { Calendar, Filter, PlusCircle, TrendingUp } from 'lucide-react';
...
const DatasetsChart = () => {
  ...
  return (
    <div className="w-full h-full flex flex-col" style={{ width: "100%", minWidth: "100%" }}>
          ...
          <ResponsiveContainer width="100%" height="100%">
            {chartType === 'bar' ? (
              ...
              <LineChart data={data} margin={{ top: 5, right: 30, left: 5, bottom: 5 }}>
                ...
                <Tooltip />
                <Legend />
                <Line type="monotone" dataKey="datasets" stroke="#4e63d9" name="Datasets" strokeWidth={2} dot={{ r: 4 }} />
              </LineChart>
            )}
          </ResponsiveContainer>
        ) : (
